...
The pump node prototype, shown below, is powered by the PoE HAT located just above the Raspberry Pi 3B+. As you can notice the prototype has just the network cable connected to provide power and Ethernet communication. On the top of HAT stack there is a [Qwiic pHAT](https://cdn.sparkfun.com/assets/9/c/4/8/6/Qwiic_pHat_for_Raspberry_Pi_v20.pdf) equipped with four connectors for I2C sensors.
